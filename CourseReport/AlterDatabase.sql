...
-- create some more stored procedures
CREATE OR ALTER PROCEDURE [dbo].[Course_GetList]
AS
	SELECT
		CourseId,
		CourseCode,
...
CREATE OR ALTER PROCEDURE [dbo].[Student_GetList]
AS
	SELECT
		StudentId,
		FirstName,
...
CREATE OR ALTER PROCEDURE [dbo].[Enrollments_GetList]
AS
	SELECT
		EnrollmentId,
		StudentId,
